...
@if($image)
    <img src="/images/{{ $image }}" width="50px" alt="Profile" class="rounded-circle">
@else
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
        ...
        <ul id="components-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
          ...
          <li>
            <a href="/dashboard/products">
              <i class="bi bi-circle"></i><span>All Products Records</span>
            </a>
          </li>
        </ul>
      </li> -->
      ...
      <!-- <li class="nav-item">
        ...
        <ul id="charts-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
          ...
          <li>
            <a href="/dashboard/students/list">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" data-bs-target="#icons-nav" data-bs-toggle="collapse" href="#">
          <i class="bi bi-gem"></i><span>All Registration Data</span><i class="bi bi-chevron-down ms-auto"></i>
        </a>
