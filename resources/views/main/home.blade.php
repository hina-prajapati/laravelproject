                  ...
                  <div class="row">
                    <div class="col-lg-7">
                      <div class="header-content">
                        <h1 class="fadeInDown animated">Celebrate Every, <span class="d-block">Cricket Journey
    ...
    <section class="float-start w-100 body-part pt-0">
      ...
      <div class="top-list-turnament">
            ...
            <div class="container">
              <div class="row row-cols-1 row-cols-lg-2">
                  <div class="col text-abouy">
                    ...
                    <p class="my-3"> Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been 
            ...
            <div class="container">
                ...
                <div class="shop-slider owl-carousel owl-theme mt-5">
                      ...
                      <div class="comon-section1-shop">
                        <div class="top-imgb-box">
                            <figure>
                              <img src="assets2/images/toppng.com-ss-elite-cricket-helmet-cricket-helmet-701x523.png" alt="shop1"/>
                            </figure>
                            <ul class="hover-list2">
                                <li>
                                  <a href="#" class="btn btn-comnb">
        ...
        <div class="mediasection d-inline-block w-100">
            <div class="container">
              ...
              <div class="row row-cols-2 row-cols-lg-4 mt-0 g-4 mt-3">
                ...
                <div class="col">
                  <a data-fancybox="wk" href="assets2/images/Centurion-Cricket-Academy-Andheri-8.webp" class="comon-links-divb05">
                    <figure>
                ...
                <div class="col">
                  <a data-fancybox="wk" href="assets2/images/Jonny-Bairstow-batting-semifinal-match-England-Australia-2019.webp" class="comon-links-divb05">
                    <figure>
                ...
                <div class="col">
                  <a data-fancybox="wk" href="assets2/images/954603-658494-india-women-cricket-team-bcci.jpg" class="comon-links-divb05">
                    <figure>
              ...
              <div class="row row cols-1 row-cols-lg-3 g-4 g-lg-5 mt-0 posrt">
                        ...
                        <div class="user-dela06 w-100 d-inline-block d-flex justify-content-between align-items-center">
                          <div class="admins d-flex align-items-center">
                              <figure class="m-0 me-2">
                                <img src="assets2/images/1mr5tvog_virat-kohli-babar-azam-afp_625x300_25_August_22.webp" alt="spbn"/>
                              </figure>
                              <span>Jmanes</span>
                          </div>
                ...
                <div class="col">
                  ...
                  <a href="#" class="comon-posrt w-100 d-inline-block my-4">
                    <div class="img-boxv w-100 d-inline-block">
                      <figure class="w-100 d-inline-block">
                          <img src="assets2/images/ANI-20221110317-0_1668092848531_1668092848531_1668092863718_1668092863718.webp" alt="pbnm"/>
                      </figure>
                      <span class="daet01">
                        14
                        <small class="d-block">Jan</small>
        ...
        <div class="sponcer-logo d-inline-block w-100">
          <div class="rtck-img">
            <img src="assets2/images/favpng_cricket-bats-kookaburra-sport-bag-cricket-clothing-and-equipment.png" alt="bnm"/>
          </div>
          <div class="container">
              <div class="mindle-heading text-center">
