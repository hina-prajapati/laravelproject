...
?>
                        ...
                        <div class="row mt-4">
                            ...
                            <div class="col-md-3 mt-3">
                                <div class="form-group">
                                    ...
                                    <input type="file" class="form-control" class="form-control" id="profile_image"
                                        name="profile_image">
                                    @error('profile_image')
                ...
                <div class="from-group">
                    <input type="text" name="lastname" class="form-control" placeholder="Last Name" required>
                            ...
                            <div class="col-md-3 mt-3">
                                <div class="from-group">
                                    <label>About:</label>
                                    <textarea name="about" class="form-control" placeholder="Tell us about yourself"
                                        class="box">{{$profile['about']}}</textarea>
                                </div>
                            </div>
                            @error('about')
                            <div class="text-danger">{{ $message }}</div>
                            ...
                            <div class="col-md-3 mt-3">
                                <div class="from-group">
                                    ...
                                    <input type="text" class="form-control box" id="phone" name="phone"
                            ...
                            <div class="col-md-3 mt-3">
                                <div class="from-group">
                                    ...
                                    <input type="date" name="datebirth" class="form-control" id="DateOfBirth"
                                        value="{{ $profile ? $profile->datebirth : '' }}" placeholder="enter datebirth"
                                        class="box">
                                </div>
                            </div>
                            @error('datebirth')
                            ...
                            <div class="col-md-3 mt-3">
                                <div class="from-group">
                                    ...
                                    <input type="number" name="age" id="Age" class="form-control" readonly
                                        value="{{ $profile ? $profile->age : '' }}" placeholder="calculate extact age"
                                        class="box"><br><br>
                                </div>
                            </div>
                            @error('age')
                                ...
                                <div class="from-group">
                                    ...
                                    <select class="form-control form-select" name="select1" id="select1">
                                        ...
                                        <option value="All-Rounder"
                                            {{ $profile->select1 === 'All-Rounder' ? 'selected' : '' }}>All-Rounder
                                        </option>
                                        <option value="Wicket Keeper"
                                            {{ $profile->select1 === 'Wicket Keeper' ? 'selected' : '' }}>Wicket Keeper
                                        </option>
                                    </select>
                                </div>
                            </div>
                                ...
                                <div class="from-group">
                                    ...
                                    <select class="form-control form-select" name="select2" id="select2">
                                        ...
                                        <option value="Middle Order"
                                            {{ $profile->select2 === 'Middle Order' ? 'selected' : '' }}>Middle Order
                                        </option>
                                        <option value="Tail" {{ $profile->select2 === 'Tail' ? 'selected' : '' }}>Tail
                                        </option>
                                        <option value="Fast" {{ $profile->select2 === 'Fast' ? 'selected' : '' }}>Fast
                                        </option>
                                        <option value="Medium Fast"
                                            {{ $profile->select2 === 'Medium Fast' ? 'selected' : '' }}>Medium Fast
                                        </option>
                                        <option value="Slow" {{ $profile->select2 === 'Slow' ? 'selected' : '' }}>Slow
                                        </option>
                                        <option value="Off Spin"
                                            {{ $profile->select2 === 'Off Spin' ? 'selected' : '' }}>Off Spin</option>
                                        <option value="Left-arm Orthodox Spin"
                                            {{ $profile->select2 === 'Left-arm Orthodox Spin' ? 'selected' : '' }}>
                                            Left-arm Orthodox Spin</option>
                                        <option value="Leg Spin"
                                            {{ $profile->select2 === 'Leg Spin' ? 'selected' : '' }}>Leg Spin</option>
                                        <option value="Left-arm Unorthodox Spin"
                                            {{ $profile->select2 === 'Left-arm Unorthodox Spin' ? 'selected' : '' }}>
                                            Left-arm Unorthodox Spin</option>
                                        <option value="Finger Spin"
                                            {{ $profile->select2 === 'Finger Spin' ? 'selected' : '' }}>Finger Spin
                                        </option>
                                        <option value="Wrist Spin"
                                            {{ $profile->select2 === 'Wrist Spin' ? 'selected' : '' }}>Wrist Spin
                                        </option>
                                        <option value="Batting All-rounder"
                                            {{ $profile->select2 === 'Batting All-rounder' ? 'selected' : '' }}>Batting
                                            All-rounder</option>
                                        <option value="Bowling All-rounder"
                                            {{ $profile->select2 === 'Bowling All-rounder' ? 'selected' : '' }}>Bowling
                                            All-rounder</option>
                                    </select>
                                </div>
                            </div>
            ...
            <option value="India" {{ ($profile && $profile->country == 'India') ? 'selected' : '' }}>India</option>
                            ...
                            <div class="col-md-3">
                                <div class="from-group">
                                    <label>Country</label>
                                    <select class="form-control-lg form-control select2" name="country" id="country">
                                        <option value="">Select Country</option>
                                        @foreach ($countries as $country)
                                        <option {{ $profile->country == $country->id ? 'selected' : '' }}
                            ...
                            <div class="col-md-3">
                                <div class="from-group">
                                    ...
                                    <select name="state" id="state" class="select2 form-control-lg form-control">
                                        ...
                                        <option {{ $profile->state == $state->id ? 'selected' : '' }}
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <select name="city" id="city" class="select2 form-control-lg form-control">
                                        ...
                                        <option {{ $profile->city == $city->id ? 'selected' : '' }}
                ...
                <input type="file" id="input-file-now-custom-3" class="form-control " name="photos[]" multiple>                </div>
                            ...
                            <div class="col-md-3">
                                <div class="from-group">
                                    <div class="raddddio" name="raddddio123">
                                        ...
                                        <input type="radio" id="bowling_left" name="bowling_orientation"
                                            value="Left Hand"
                                            {{ ($profile && $profile->bowling_orientation == 'Left Hand') ? 'checked' : '' }}>
                                        <label for="bowling_left">Left Hand</label>
                                        <input type="radio" id="bowling_right" name="bowling_orientation"
                                            value="Right Hand"
                                            {{ ($profile && $profile->bowling_orientation == 'Right Hand') ? 'checked' : '' }}>
                            ...
                            <div class="col-md-3">
                                <div class="from-group">
                                    <div class="raddddio" name="raddddio">
                                        ...
                                        <input type="radio" id="batting_left" name="batting_orientation"
                                            value="Left Hand"
                                            {{ ($profile && $profile->batting_orientation == 'Left Hand') ? 'checked' : '' }}>
                                        <label for="batting_left">Left Hand</label>
                                        <input type="radio" id="batting_right" name="batting_orientation"
                                            value="Right Hand"
                                            {{ ($profile && $profile->batting_orientation == 'Right Hand') ? 'checked' : '' }}>
                            ...
                            <div class="col-lg-12 d-flex mt-4">
                                ...
                                <a class="btn comon-btn ms-3" style="background-color: #0d6efd"
                                    href="{{ route('main/profile-page') }}">
