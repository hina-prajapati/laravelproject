                        ...
                        <div class="row mt-4">
                            ...
                            <div class="col-md-3 mt-3">
                                <div class="form-group">
                                    <label>Date:</label>
                                    <input type="date" id="date" name="date" value="{{ old('date') }}" class="form-control m-2" placeholder="Date" data-scroll="true">
                                </div>
                            ...
                            <div class="col-md-3 mt-3">
                                <div class="from-group">
                                    ...
                                    <input type="text" name="opppsitionTeam" id="opppsitionTeam" value="{{ old('opppsitionTeam') }}" class="form-control m-2" placeholder="Opposion Team" data-scroll="true">
                                </div>
                            ...
                            <div class="col-md-3 mt-3">
                                <div class="from-group">
                                    ...
                                    <input type="text" name="tournament" id="tournament" value="{{ old('tournament') }}" class="form-control m-2" placeholder="tournament">
                                </div>
                            ...
                            <div class="col-md-3 mt-3">
                                <div class="from-group">
                                    ...
                                    <input type="text" name="venue" id="venue" value="{{ old('venue') }}" class="form-control m-2" placeholder="Venue">
                                </div>
                     ...
                     @enderror</div>
                            ...
                            <div class="col-md-3 mt-3">
                                <div class="from-group">
                                    <label>Match Type:</label>
                                    <div class="custom-select form-control m-2">
                                        <select class="select2" name="match_type" id="select_opt_match_type" onchange="showfield(this.options[this.selectedIndex].value)">
                            ...
                            <div class="col-md-3 mt-3">
                                <div class="from-group">
                                    ...
                                    <div class="custom-select form-control m-2">
                                        <select name="batting_pos" id="batting_pos" class="select2">
                            ...
                            <div class="col-md-3 mt-3">
                                <div class="from-group">
                                    ...
                                    <input type="number" id="max4s" name="no4s" value="{{ old('no4s') }}" class="form-control m-2" placeholder="Number of 4s.....">
                                </div>
                                @error('no4s')
                                <div class="alert text-danger">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="col-md-3 mt-3">
                                <div class="from-group">
                                    ...
                                    <input type="number" id="max6s" name="no6s" value="{{ old('no6s') }}" class="form-control m-2" placeholder="Number of 6s.....">
                                </div>
                                @error('no6s')
                                <div class="alert text-danger">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="col-md-3 mt-3">
                                <div class="from-group">
                                    ...
                                    <input type="number" id="nomo" name="nomo" value="{{ old('nomo') }}" class="form-control m-2" placeholder="Number Of Maidan Overs.....">
                                </div>
                                @error('nomo')
                                <div class="alert text-danger">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="col-md-3 mt-3">
                                <div class="from-group">
                                    ...
                                    <input type="number" id="norsif" name="norsif" value="{{ old('norsif') }}" class="form-control m-2" placeholder="Number of Run Saved in Fielding.....">
                                </div>
                                @error('norsif')
                                <div class="alert text-danger">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="col-md-3 mt-3">
                                <div class="from-group">
                                    ...
                                    <input type="number" id="noc" name="noc" max="10" value="{{ old('noc') }}" class="form-control m-2" placeholder="Number Of Catches.....">
                                </div>
                                @error('noc')
                                <div class="alert text-danger">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="col-md-3 mt-3">
                                <div class="from-group">
                                    ...
                                    <input type="number" name="norouts" id="norouts" max="10" value="{{ old('norouts') }}" class="form-control m-2" placeholder="Number Of Runs Outs.....">
                                </div>
                                @error('norouts')
                                <div class="alert text-danger">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="col-md-3 mt-3">
                                <div class="from-group">
                                    ...
                                    <input type="number" id="nostump" name="nostump" max="10" value="{{ old('nostump') }}" class="form-control m-2" placeholder="Number Of stumpings.....">
                                </div>
                                @error('nostump')
                                <div class="alert text-danger">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="col-md-3 mt-3">
                                <div class="from-group">
                                    ...
                                    <input type="number" id="rgbmis" name="rgbmis" value="{{ old('rgbmis') }}" class="form-control m-2" placeholder="Runs Given by misfiled....">
                                </div>
                                @error('rgbmis')
                                <div class="alert text-danger">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="col-md-3 mt-3">
                                <div class="from-group">
                                    ...
                                    <input type="number" id="cmissed" name="cmissed" value="{{ old('cmissed') }}" class="form-control m-2" placeholder="Catches Missed.....">
                                </div>
                                @error('cmissed')
                                <div class="alert text-danger">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="col-md-3 mt-3">
                                <div class="from-group">
                                    ...
                                    <input type="number" id="stump_missed" name="stump_missed" value="{{ old('stump_missed') }}" class="form-control m-2" data-scroll="true" placeholder="Stumpings Missed.....">
                                </div>
                                @error('stump_missed')
                                <div class="alert text-danger">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="col-md-3 mt-3">
                                <div class="from-group">
                                    ...
                                    <input type="number" id="runouts" name="runouts" value="{{ old('runouts') }}" class="form-control m-2" placeholder="Run-Out Missed.....">
                                </div>
                                @error('runouts')
                                <div class="alert text-danger">{{ $message }}</div>
                                @enderror
