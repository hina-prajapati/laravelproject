                        ...
                        <div class="row mt-4">
                            ...
                            <div class="col-md-3 mt-3">
                                <div class="from-group">
                                    ...
                                    <div class="custom-dropdown form-control m-2">
                                        <select id="dropdown-input" name="match_type" class="select2 dropdown-input" style="border: none;" onchange="toggleCustomInput()">
                                            <option value=""> Match Type...</option>
                                            <option value="Test-5 Days" {{ $posts->match_type == 'Test-5 Days' ? 'selected' : '' }}>Test-5 Days
                                            </option>
                                            <option value="Test-3 Days" {{ $posts->match_type == 'Test-3 Days' ? 'selected' : '' }}>Test-3 Days
                                            </option>
                                            <option value="Test-2 Days" {{ $posts->match_type == 'Test-2 Days' ? 'selected' : '' }}>Test-2 Days
                                            </option>
                                            <option value="One Day-50 Over" {{ $posts->match_type == 'One Day-50 Over' ? 'selected' : '' }}>One
                                                Day-50 Over</option>
                                            <option value="One Day-40 Over" {{ $posts->match_type == 'One Day-40 Over' ? 'selected' : '' }}>One
                                                Day-40 Over</option>
                                            <option value="One Day-30 Over" {{ $posts->match_type == 'One Day-30 Over' ? 'selected' : '' }}>One
                                                Day-30 Over</option>
                                            <option value="One Day-25 Over" {{ $posts->match_type == 'One Day-25 Over' ? 'selected' : '' }}>One
                                                Day-25 Over</option>
                                            <option value="T20" {{ $posts->match_type == 'T20' ? 'selected' : '' }}>T20
                                            </option>
                                            <option value="T10" {{ $posts->match_type == 'T10' ? 'selected' : '' }}>T10
                                            </option>
                                            <option value="Other" {{ $posts->match_type == 'Other' ? 'selected' : '' }}>
                                                Other</option>
                                        </select>
                            ...
                            <div class="col-md-3 mt-3">
                                <div class="from-group">
                                    ...
                                    <div class="custom-select form-control m-2">
                                        <select id="type_ball" name="type_ball" class="select2">
                                            <option value="">Select Type</option>
                                            @foreach($ballTypes as $ballType)
                                            <option value="{{ $ballType }}" {{ $posts->type_ball == $ballType ? 'selected' : '' }}>{{ $ballType }}
                                            </option>
                                            @endforeach
                                        </select>
                            ...
                            <div class="col-md-3 mt-3">
                                <div class="from-group">
                                    ...
                                    <div class="custom-select form-control m-2">
                                        <select id="select_role" name="select_role" class="select2">
                                            <option value="">Select Role</option>
                                            @foreach($roles as $role)
                                            <option value="{{ $role }}" {{ $posts->select_role === $role ? 'selected' : '' }}>{{ $role }}
                                            </option>
                                            @endforeach
                                        </select>
                            ...
                            <div class="col-md-3 mt-3 mb-4">
                                <div class="from-group">
                                    ...
                                    <div class="custom-select form-control m-2">
                                        <select name="match_result" id="match_result" class="select2">
                                            <option value="">Match Result</option>
                                            <option value="Won" {{ $posts->match_result === 'Won' ? 'selected' : '' }}>
                                                Won</option>
                                            <option value="Lost" {{ $posts->match_result === 'Lost' ? 'selected' : '' }}>Lost</option>
                                            <option value="Draw/Tie" {{ $posts->match_result === 'Draw/Tie' ? 'selected' : '' }}>Draw/Tie
                                            </option>
                                            <option value="Abandoned" {{ $posts->match_result === 'Abandoned' ? 'selected' : '' }}>Abandoned
                                            </option>
                                        </select>
                                    </div>
                                </div>
                            ...
                            <div class="col-md-3 mt-3">
                                <div class="from-group">
                                    ...
                                    <div class="custom-select">
                                        <select id="batting_pos" name="batting_pos" class="select2 form-control">
                                            <option value="">Batting Position</option>
                                            @foreach($battingPositions as $position)
                                            <option value="{{ $position }}" {{ $posts->batting_pos == $position ? 'selected' : '' }}>{{ $position }}
                                            </option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="from-group">
                                    ...
                                    <div class="col-xs-6">
                                        <div class="custom-select form-control">
                                            <select class="select2 form-control custom-select form-control m-2" name="select1" id="select1">
                                                <option value="">Wicket In Which Fashion</option>
                                                <option value="Bowled" {{ $posts->select1 === 'Bowled' ? 'selected' : '' }}>
                                                    Bowled</option>
                                                <option value="Catch out" {{ $posts->select1 === 'Catch out' ? 'selected' : '' }}>Catch out
                                                </option>
                                                <option value="Caught & Bowled" {{ $posts->select1 === 'Caught & Bowled' ? 'selected' : '' }}>Caught
                                                    &
                                                    Bowled</option>
                                                <option value="Caught Behind" {{ $posts->select1 === 'Caught Behind' ? 'selected' : '' }}>Caught
                                                    Behind</option>
                                                <option value="LBW" {{ $posts->select1 === 'LBW' ? 'selected' : '' }}>
                                                    LBW
                                                </option>
                                                <option value="Hit Wicket" {{ $posts->select1 === 'Hit Wicket' ? 'selected' : '' }}>Hit Wicket
                                                </option>
                                                <option value="Retired Hurt" {{ $posts->select1 === 'Retired Hurt' ? 'selected' : '' }}>Retired
                                                    Hurt
                                                </option>
                                                <option value="Not Out" {{ $posts->select1 === 'Not Out' ? 'selected' : '' }}>Not Out
                                                </option>
                                            </select>
                                        </div>
                                    </div>
                            ...
                            <div class="col-md-3 mt-3">
                                <div class="from-group">
                                    ...
                                    <div class="col-xs-6">
                                        <div class="custom-select form-control">
                                            <select class="select2 form-control custom-select form-control m-2" name="select2" id="select2">
                                                <option value="">If Catch Out, Where</option>
                                                <option value="Slip" {{ $posts->select2 === 'Slip' ? 'selected' : '' }}>
                                                    Slip
                                                </option>
                                                <option value="Long On" {{ $posts->select2 === 'Long On' ? 'selected' : '' }}>Long On
                                                </option>
                                                <option value="Long Off" {{ $posts->select2 === 'Long Off' ? 'selected' : '' }}>Long Off
                                                </option>
                                                <option value="Mid On" {{ $posts->select2 === 'Mid On' ? 'selected' : '' }}>
                                                    Mid On</option>
                                                <option value="Mid Off" {{ $posts->select2 === 'Mid Off' ? 'selected' : '' }}>Mid Off
                                                </option>
                                                <option value="Cover" {{ $posts->select2 === 'Cover' ? 'selected' : '' }}>
                                                    Cover</option>
                                                <option value="Point" {{ $posts->select2 === 'Point' ? 'selected' : '' }}>
                                                    Point</option>
                                                <option value="Silly Point" {{ $posts->select2 === 'Silly Point' ? 'selected' : '' }}>Silly
                                                    Point
                                                </option>
                                                <option value="Third Man" {{ $posts->select2 === 'Third Man' ? 'selected' : '' }}>Third Man
                                                </option>
                                                <option value="Theep Third Man" {{ $posts->select2 === 'Theep Third Man' ? 'selected' : '' }}>Theep
                                                    Third Man</option>
                                                <option value="Gully" {{ $posts->select2 === 'Gully' ? 'selected' : '' }}>
                                                    Gully</option>
                                            </select>
                                        </div>
                                    </div>
                            ...
                            <div class="col-md-3 mt-3">
                                <div class="from-group">
                                    ...
                                    <div class="custom-select form-control m-2">
                                        <select name="fielding_pos" id="fielding_pos" class="select2">
                                            <option value="">Fielding Position</option>
                                            @foreach($fieldingPositions as $position)
                                            <option value="{{ $position }}" {{ $posts->fielding_pos === $position ? 'selected' : '' }}>
                                                {{ $position }}
                                            </option>
                                            @endforeach
                                        </select>
                            ...
                            <div class="col-md-3 mt-3">
                                <div class="from-group">
                                    ...
                                    <div class="custom-select form-control m-2">
                                        <select name="award" id="award" class="select2">
                                            <option value="">Select an Award</option>
                                            <option value="Man of The Match" {{ $posts->award === 'Man of The Match' ? 'selected' : '' }}>Man of
                                                The
                                                Match</option>
                                            <option value="Best Bowler" {{ $posts->award === 'Best Bowler' ? 'selected' : '' }}>Best Bowler
                                            </option>
                                            <option value="Best Batsman" {{ $posts->award === 'Best Batsman' ? 'selected' : '' }}>Best
                                                Batsman
                                            </option>
                                            <option value="Best Fielder" {{ $posts->award === 'Best Fielder' ? 'selected' : '' }}>Best
                                                Fielder
                                            </option>
                                            <option value="Best All-Rounder" {{ $posts->award === 'Best All-Rounder' ? 'selected' : '' }}>Best
                                                All-Rounder</option>
                                            <option value="None" {{ $posts->award === 'None' ? 'selected' : '' }}>
                                                None
                                            </option>
                                        </select>
                                    </div>
