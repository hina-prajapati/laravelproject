            ...
            @auth
             ...
             <ul class="dropdown-menu  cart-dropdown-ne" >
               ...
               <li>
                 ...
                 <h5>Welcome To This Page: {{ auth()->user()->name }}</h5>
                 </div>
               </li>
               @endauth
               <li>
                @auth
                 <a href="{{ url('/change-password') }}" class="btn cart-drop-bn"> Update Password </a>
                 @endauth
               </li>
               @auth
                <li>
      ...
      <div class="row g-lg-5 mt-0">
        <div class="col-lg-5">
           <div class="logo-about mt-3 mt-lg-0 d-md-flex align-items-start justify-content-between">
              ...
              <p class="col-lg-8 ms-md-4 mt-4 mt-md-0 text-white spt"> Lorem Ipsum is simply dummy text of the printing and typesetting industry.
         ...
         <form action="{{route('/login')}}" method="post">
          ...
          @endif
            ...
            <p class="text-center  mt-3">  
              ...
              <p class="text-center  mt-3"> Do not have an account? 
                <a data-bs-toggle="modal" class="regster-bn" data-bs-target="#memberModal" data-bs-dismiss="modal" href="{{route('/register')}}"> Register </a>  </p>
            </div>
         </form>
      </div>
    </div>
...
function validateForm() {
    ...
    //     // Reset all input fields in the form after a delay to allow the submission process to finish
    //     setTimeout(function() {
    //         registrationForm.reset();
    //     }, 500); // Adjust the delay as needed
    // }
